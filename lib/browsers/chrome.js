...
chrome.spawn = function(options) {
	return new Promise((resolve, reject) => {
		...
		this.chromeChild = spawn(location, this.options.chromeFlags || ['--no-sandbox', '--blink-settings=imagesEnabled=false', '--headless', '--disable-gpu', '--remote-debugging-port=9222', '--hide-scrollbars']);
